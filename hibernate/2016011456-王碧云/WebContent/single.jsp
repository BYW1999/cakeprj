			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">		
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="${singlecake.smapic1 }">
								<div class="thumb-image"> <img src="${singlecake.smapic1 }" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="${singlecake.smapic1 }">
								 <div class="thumb-image"> <img src="${singlecake.smapic1 }" data-imagezoom="true" class="img-responsive"> </div>
							</li>
				...
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					...
					<div class="galry">
						<div class="prices">
							<h5 class="item_price">$${singlecake.cakediscount }</h5>
						</div>
						<div class="rating">
							<span>☆</span>
							<span>☆</span>
					...
					<div class="btn_form">
						<a href="cartController?cakeid=${singlecake.cakeid }" class="add-cart item_add">ADD TO CART</a>	
					</div>
					<div class="tag">
			...
			<div class="panel-group collpse" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel panel-default">
					...
					<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
						<div class="panel-body">
							用户 ${comment.user.usermail }说：${comment.content }
						</div>
					</div>
					</c:forEach>
				</div>
