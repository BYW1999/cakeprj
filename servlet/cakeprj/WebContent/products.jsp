		...
		<div class="container">
			...
			<c:forEach items="${page.list }" var="p">
				<div class="product-grid">
					<a href="SingleServlet?cakeid=${p.cakeid }">				
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<a href="AddCartServlet?cakeid=${p.cakeid }&pageNum=${page.currentPageNum}"><input type="button" class="item_add items" value="Add"></a>
			...
			<table>
				...
				<a href="ProductsServlet?pageNum=1&typeid=${typeid}&cakename=${cakename}">首页</a>
				<a href="ProductsServlet?pageNum=${page.prePageNum }&typeid=${typeid}&cakename=${cakename}">上一页</a>
				<a href="ProductsServlet?pageNum=${page.nextPageNum }&typeid=${typeid}&cakename=${cakename}">下一页</a>
				<a href="ProductsServlet?pageNum=${page.totalPageNum }&typeid=${typeid}&cakename=${cakename}">尾页</a>
				</td></tr>
			</table>
			</div>	
